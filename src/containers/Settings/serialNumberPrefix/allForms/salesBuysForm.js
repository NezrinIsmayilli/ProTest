...
const SalesBuys = props => {
  ...
  const isReadOnly =
    permissionKeys.find(permission => permission.key === 'msk_documents')
      .permission === 1;
  const defaultData = [
    { type: 1, docsCount: 0, docs: [] },
    { type: 2, docsCount: 0, docs: [] },
    { type: 3, docsCount: 0, docs: [] },
    { type: 4, docsCount: 0, docs: [] },
    { type: 5, docsCount: 0, docs: [] },
    { type: 6, docsCount: 0, docs: [] },
    { type: 7, docsCount: 0, docs: [] },
    { type: 8, docsCount: 0, docs: [] },
  ];
...
export const SalesBuysForm = connect(
  mapStateToProps,
  {}
)(SalesBuys);
