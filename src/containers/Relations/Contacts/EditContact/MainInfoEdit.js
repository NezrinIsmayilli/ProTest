		...
		<>
			...
			>
				{getFieldDecorator('name', {
					...
					<Input size="large" className={styles.select} placeholder="Yazın" />
				)}
			</ProFormItem>
			<ProFormItem
				label="Əlaqə tipi"
			...
			>
				{getFieldDecorator('category', {
					...
					<ProSelect mode="multiple" data={Object.values(contactCategories)} />
				)}
			</ProFormItem>
			<ProFormItem
				label="VÖEN"
			...
			<Row style={{ margin: '10px 0', display: 'flex', alignItems: 'center' }}>
				<Col sm={20} lg={22}>
					<ProFormItem
					...
					>
						{getFieldDecorator('facebook', {
							getValueFromEvent: event => handleFacebookValue(event),
