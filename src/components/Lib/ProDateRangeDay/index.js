...
export function ProDateRangeDay(props) {
  const {
    showIcon = false,
    year = false,
    buttonSize = 'default',
  ...
  const [state, setState] = useState({
    startValue:defaultStartValue ? moment(defaultStartValue,'DD-MM-YYYY') :( notRequired ? undefined : moment().startOf('day')),
    endValue:defaultEndValue ? moment(defaultEndValue,'DD-MM-YYYY'):( notRequired ? undefined : moment().endOf('day')),
    selected: notRequired ? undefined : 'day',
  });
